...
import { AuthActionTypes, Login, LoginFailure, LoginSuccess, LogoutFailure, LogoutSuccess, Signup, SignupFailure, SignupSuccess } from '../actions/auth';
    ...
    signup$ = createEffect(() => this.actions$.pipe(
        ...
        mergeMap((user: NewAccount) =>
            from(this.authService.create(user))
                .pipe(
                    mergeMap(createdUser => of(
                        new SignupSuccess(),
                        new LoginSuccess(createdUser))),
